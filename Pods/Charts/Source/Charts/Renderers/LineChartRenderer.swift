...
open class LineChartRenderer: LineRadarRenderer
{
    ...
    func replaceTimeText(_ text: String) -> String {
        ...
        let timePattern = "\\b(\\d{2}:\\d{2}|Kolhydrater|Kolhydratersekvivalenter| / Fett \\d+,\\d+ g| / Fett \\d+ g| / Protein \\d+,\\d+ g| / Protein \\d+ g|Fett/Protein|Måltid|Bolus|SMB|Fingerstick|mmol/L|E)\\b"
