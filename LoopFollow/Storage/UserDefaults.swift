...
class UserDefaultsRepository {
    ...
    static let showMinus24hLine = UserDefaultsValue<Bool>(key: "showMinus24hLine", default: true)
    ...
    static let alertMissedReading = UserDefaultsValue<Int>(key: "alertMissedReading", default: 21)
    ...
    static let alertNotLooping = UserDefaultsValue<Int>(key: "alertNotLooping", default: 21)
