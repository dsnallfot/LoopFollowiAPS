...
class PumpHistoryViewController: ThemedViewController, UITableViewDataSource, UITableViewDelegate, UIDocumentPickerDelegate {
    ...
    private func setupNavigationBar() {
        ...
        if isModalRoot {
            // Modal: custom buttons replace back button
            //navigationItem.leftBarButtonItem = []
            navigationItem.rightBarButtonItems = [doneBtn, statsBtn, leftItem]
        } else {
            // Pushed: keep back button, supplement with custom buttons
            navigationItem.leftItemsSupplementBackButton = true
            //navigationItem.leftBarButtonItems = []
            navigationItem.rightBarButtonItems = [statsBtn, leftItem]
        }
    }
...
final class PumpSessionStatsViewController: ThemedTableViewController {
    ...
    private enum CountRow: Int, CaseIterable { case all, lt1, h1to50, h50to70, gt70 }
    private enum AvgRow: Int, CaseIterable { case all, allExclLt1, lt1, h1to50, h50to70, gt70 }
